			...
			<div class="kt-portlet__head">
				...
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
						...
						<li class="nav-item">
							<a href="{{ url('add_question')}}" class="btn-accordion btn btn-primary btn-xs"><i class="flaticon2-plus"></i>&nbsp;Add</a>
						</li>
				...
				<div class="accordion  accordion-toggle-arrow" id="accordionExample4">
					...
					<div id="collapseOne4" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample4">
						<div class="card-body" style="background:#e2f0f7;">
							...
							<div class="row">
							<label class="col-lg-1 col-xl-1 col-xxl-1" style="padding-top:9px;">Course</label>
							...
							<label class="col-lg-2 col-xl-2 col-xxl-2" style="padding-top:9px;">Select Question Paper</label>
							<div class="col-lg-4 col-xl-4 col-xxl-4">
							   <select id="flt_qpaper_id" class="form-control " name="flt_qpaper_id" required>
								<option value="">--select--</option>
...
$("#flt_course_id").change(function()
{
 ...
 var table = $('#datatable').DataTable({
		...
		ajax: {
          url: "view_mcq_questions",
          data: function (data) 
		    {
                data.searchByQpaper = $('#flt_qpaper_id').val();
