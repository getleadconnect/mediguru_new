...
<div class="col-lg-12 col-xl-12 col-xxl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			...
			<div class="col-lg-4 col-xl-4 col-xxl-4">
				...
				<form method="post" onsubmit=" return checkValues();" action="{{url('save_qpaper_questions')}}" enctype="multipart/form-data">
					@csrf
							<div class="form-group">
								<label >Select Course </label>
							    	<select class="form-control"  id="crs_id" name="crs_id" required>
										<option value="">--select--</option>
										@foreach($crs as $r)
							...
							<div class="form-group">
								...
								<select class="form-control kt-select2 qpaper_id" id="kt_select2_1" name="qpaper_id" required>
										<option value="">--select--</option>
							        </select>
									<label class="mt-2">Questions: <span id="total_quest" style="color:blue;font-weight:600;">0 Nos</span></label>
									 <span class="mt-2">&nbsp;&nbsp;<a href="{{url('mcq_questions')}}" id="" class=" btnQView">View Questions</a></span>
							</div>
							
							<label style="font-size:12px;color:#4a4ae5;"><b> Add questions and Save the question paper</b></label>
