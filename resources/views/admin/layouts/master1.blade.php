...
<html lang="en">
	...
	<head>
		...
		<link rel="shortcut icon" href="{{ asset('media/logos/logo-1.png')}}" />
			 ...
			 <button class="kt-aside-close " id="kt_aside_close_btn"><i class="la la-close"></i></button>
				<div class="kt-aside  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper" style="position:fixed !important;min-width: 250px;">
						<div id="kt_aside_menu" class="kt-aside-menu kt-scroll" data-scroll="true" style="margin-top:45px;height:600px;border-right: 1px solid #b7b7b7;" data-ktmenu-vertical="1">
							...
							<ul class="kt-menu__nav ">
								...
								<i class="kt-menu__link-icon flaticon-squares icon-color"></i>
								<span class="kt-menu__link-text">Master</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('banners')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Dashboard Banner</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('courses')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Courses</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('subjects')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Course Subjects</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('lessons')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Lessons</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('promocodes')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Promocodes</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('reorder_subjects')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Re-Order Sub-courses</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-book icon-color"></i>
								<span class="kt-menu__link-text">Materials</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<!--<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('import_videos')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Import Vimeo Videos</span></a></li>-->
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('videos')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add Videos</span></a></li>
											<!--<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('class_videos')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add Class Videos</span></a></li>-->
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('add_materials')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add Materials</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('materials')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">View Materials</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-interface-3 icon-color"></i>
								<span class="kt-menu__link-text">Question Bank</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('qb_subjects')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Subjects</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('add_question')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add Questions</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('import_questions')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Import Questions</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('questions')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">View Questions</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-notes icon-color"></i>
								<span class="kt-menu__link-text">Question Papers</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('mcq_question_papers')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Mcq Question Papers</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('live_question_papers')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Live Question Papers</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('prepare_questions')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Prepare Test Q-Papers</span></a></li>
											<!--<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('import_mcq_questions')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Import Mcq Questions</span></a></li>-->
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('mcq_questions')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Live/Mock Test Questions</span></a></li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-file icon-color"></i>
								<span class="kt-menu__link-text">News-Live Class/Test</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('latest_news')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add news/live classes</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('live_mock_tests')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add live mock tests</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-tabs icon-color"></i>
								<span class="kt-menu__link-text">Prepare Items</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('lesson_videos')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Set Lesson videos</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('lesson_materials')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Set Lesson materials</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('lesson_mcq_tests')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Set Lesson mock tests</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('lesson_live_tests')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Set Lesson live tests</span></a></li>
											<li><hr style="margin:3px;"></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('view_all_lesson_videos')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">View lesson videos</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('view_all_lesson_materials')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">View lesson materials</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('view_lesson_mcq_qpapers')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">View lesson mcq tests</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('view_lesson_live_qpapers')}}" class="kt-menu__link ">	<i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">View lesson live tests</span></a></li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon la la-users icon-color"></i>
								<span class="kt-menu__link-text">Students</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('add_student')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add Students</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('students')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Students</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('subscriptions')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Subscriptions</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('student_devices')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Student Devices</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('attended_tests')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Student Attended Tests</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon2-list-3 icon-color"></i>
								<span class="kt-menu__link-text">Packages</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
										   <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('packages')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Subject Packages</span></a></li>
										   <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('course_packages')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Course Packages</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon2-user-outline-symbol icon-color"></i>
								<span class="kt-menu__link-text">Staffs</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
										   <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('staffs')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Staffs</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-user icon-color"></i>
								<span class="kt-menu__link-text">Users</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
										   <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('admin_users')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Admin Users</span></a></li>
										    <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('student_users')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Student Users</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-coins icon-color"></i>
								<span class="kt-menu__link-text">Payments</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
										   <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('payments')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Payments</span></a></li>
										</ul>
									</div>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-folder-1 icon-color"></i>
								<span class="kt-menu__link-text">Reports</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
										
										   <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('exam_reports')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Mcq test reports(Rank)</span></a></li>
										   
										   <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('mcq_student_wise_report')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Student mock test reports</span></a></li>
										  		
										  <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('student_list_report')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Registred Students report</span></a></li>
										  
										<li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('subscription_list_report')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Subscribed Students report</span></a></li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon-signs-1 icon-color"></i>
								<span class="kt-menu__link-text">Options</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
										
										   <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('like_dislikes')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Like And Dislikes</span></a></li>
										   
										   <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('comments')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">View Comments</span></a></li>
										   
										   <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('general_feedbacks')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">General Feedbacks</span></a></li>
										   
										   <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('notifications')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Notifications</span></a></li>
										   
										    <li class="kt-menu__item " aria-haspopup="true">
										   <a href="{{url('chat')}}" class="kt-menu__link ">
										   <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Chat</span></a></li>
								...
								<!--<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
								<a href="javascript:;" class="kt-menu__link kt-menu__toggle">
								<i class="kt-menu__link-icon flaticon2-analytics-2 icon-color"></i>
								<span class="kt-menu__link-text">Config</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
								...
								<li class="kt-menu__item " aria-haspopup="true">
								<a href="#" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-medical-records-1 icon-color"></i><span class="kt-menu__link-text">Console</span></a>
								</li> -->
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<!-- begin:: Header -->
					<div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed " style="background:#355434;"> <!-- #3d644d -->

						<!-- begin:: Aside -->
						<div class="kt-header__brand kt-grid__item  " id="kt_header_brand" style="background:#355434;width: 250px;">
							...
							<div class="kt-header-mobile__logo" style="width: 100px;display: block;">
								...
								<img alt="Logo" src="{{asset('media/logos/logo.png')}}" style="width: 120px;margin-top: 5px;">
								</a>
							</div>
						</div>
					...
					<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer" style="border-top:1px solid #b7b7b7;">
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-footer__copyright">
								2022&nbsp;&copy;&nbsp;<a href="http://bcompetitive.in" target="_blank" class="kt-link">bcompetitive</a>
							</div>
