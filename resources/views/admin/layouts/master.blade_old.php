...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--solid kt-page--loading" style="min-height:600px;overflow-y:scroll;">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			...
			<div class="kt-header-mobile__toolbar" style="background: #1b3f2a;">
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
			 ...
			 <button class="kt-aside-close " id="kt_aside_close_btn"><i class="la la-close"></i></button>
				<div class="kt-aside  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
					...
					<!-- begin:: Aside Menu -->
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper" style="position:fixed !important;min-width: 240px;">
						<div id="kt_aside_menu" class="kt-aside-menu kt-scroll" data-scroll="true" style="margin-top:45px;height:600px;" data-ktmenu-vertical="1">
							...
							<ul class="kt-menu__nav ">
								...
								<span class="kt-menu__link-text">Master</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('subjects')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Sub Courses</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{url('lessons')}}" class="kt-menu__link "> <i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Add Lessons</span></a></li>
								...
								<span class="kt-menu__link-text">Packages</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
										   <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('packages')}}" class="kt-menu__link "><i class="kt-menu__link-bullet fas fa-caret-right"></i><span class="kt-menu__link-text">Packages</span></a></li>
										</ul>
									</div>
								</li>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<!-- begin:: Header -->
					<div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed " style="background:#2f7783;"> <!-- #3d644d -->

						<!-- begin:: Aside -->
						<div class="kt-header__brand kt-grid__item  " id="kt_header_brand" style="background:#2f7783;">
						...
						<div class="kt-header__topbar">
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl" style="width:270px; !important;">
									...
									<!--begin: Head -->
									<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background:#5b97a1;/*background-image: asset({{ asset('media/misc/bg-1.jpg')}});*/">
