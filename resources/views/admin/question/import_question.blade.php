				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-lg-12">
							...
							<ul class="st-ul mt-2 mb-3">
								...
								<li class="pb-2"><b>1. </b>To import Text Questions, <a style="color:blue" href="{{ url('excel_template/excel_question_template.xlsx')}}" download="excel_question_template.xlsx"><span style="font-weight:700;font-size:14px;">Click Here</span></a>
								to download Excel Template file.</li>
								<li class="pb-2"><b>2. </b>Open Excel file and add question details into the file. And Save the file</li>
							    <li class="pb-2"><b>3. </b>In the import question, Select Subject and select the saved Excel file and Submit.</li> 
							</ul>
														
							<form method="post" action="{{url('import_to_excel')}}" enctype="multipart/form-data">
							
							@csrf
							 
							<div class="form-group">
							 <div class="row">
								<label class="col-lg-2 col-xl-2 col-xxl-2 col-form-label">Subject Name </label>
								<div class="col-lg-5 col-xl-5 col-xxl-5">
									<select class="form-control kt-select2 subject_id" placeholder="Select Subject" id="kt_select2_1" name="subject_id" required>
