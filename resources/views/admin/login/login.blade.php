	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-aside--minimize kt-page--loading">
		...
		<div class=" kt-grid--root kt-page">
			<div class="kt-login kt-login--v3 kt-login--signin" id="kt_login">
				<div class="kt-grid__item  kt-grid kt-grid--hor" style="background-color:#fff; /*background-image: url(assets/media/bg/bg-3.jpg);*/ ">  <!-- kt-grid__item--fluid class removed-->
				
						<div class="kt-login__logo text-center">
								<a href="#">
									<!--<img src="{{asset('media/logos/logo1.svg')}}" style="width:120px;"> -->
									<img src="{{asset('media/logos/logo.png')}}" style="width:200px;">
								</a>
						</div>
										
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper kt-login__wrapper-new"  style="border-radius:15px;background:#5f7a5f;min-height:365px !important;">
				
						<div class="kt-login__container">
							
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title" style="color:#ffff;">Sign In To Admin</h3>
								</div>
								
								<form class="kt-form" method="post" action="{{ url('login') }}">
								@csrf
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Email" name="email" style="background:#fff;" autocomplete="off" required>
									</div>
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Password" style="background:#fff;"  name="password" required>
									</div>
									
									@if($errors->has('err'))
										<div class="error text-center mt-2" style="color:red;">&nbsp;{{ $errors->first('err') }}</div>
									@endif
