							 ...
							 <thead>
										...
										<tr>
										  ...
										  <td width="100px">
											...
											<a href="{{url('delete_banner').'/'.$r->id}}" id="conf" class=" btn btn-danger btn-elevate btn-circle btn-icon" title="Delete"><i class="fa fa-trash"></i></a> 
											@if($r->status==1)
											<a href="{{url('deactivate_banner').'/'.$r->id}}" class="btn btn-warning btn-elevate btn-circle btn-icon" title="Deactivate"><i class="fa fa-times"></i></a> 	
											@else
											<a href="{{url('activate_banner').'/'.$r->id}}" class="btn btn-success btn-elevate btn-circle btn-icon" title="Activate"><i class="fa fa-check"></i></a> 	
											@endif
										</td>
