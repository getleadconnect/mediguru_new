		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			...
			@if(!empty($crs))
			   @foreach($crs as $key=>$r)
					...
					@php 
					if($r->course_type==1){ $color='#e6e3e2';}else { $color='#cff1ea';}
					@endphp
						...
						<div class="kt-portlet kt-portlet--head-xl kt-portlet--mobile" style="border:1px solid #d9efda; border-radius:5px;">
									...
									<div class="kt-portlet__head" style="background:{{$color}};">
										    <div class="kt-portlet__head-label">
												...
												<b><span class="kt-badge kt-badge--dark kt-badge--md">{{$r->reorder_no}}</span>&nbsp;&nbsp;{{ $r->course_name }}
												(
													@if($r->status==1)
														<span style="color:#0a7e0a !important;">Active</span>
													@else
														<span style="color:red !important;">Inactive</span>
													@endif
												)
												</b>
												</h3>
											...
											<div class="kt-portlet__head-toolbar" style="margin-top: 10px;margin-right: -10">
												<div class="dropdown dropdown-inline">
													<a href="#" class="btn btn-default btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background:#458b49;">
							...
							<div class="details" style="background:{{$color}};padding:3px 10px;">		
								<div class="row" >
									<div class="col-lg-1 text-center">
										<img src="{{ config('constants.file_path').$r->course_icon}}" style="width:40px;height:40px">
									</div>	
									...
									<div class="col-lg-11">
										...
										<p>
										Unique Id : <span>{{ $r->unique_id }}</span>  
										@if($r->subscription_end_date!="")
										|&nbsp;&nbsp;AE-Date : <span>{{date_create($r->subscription_end_date)->format('d-m-Y')}}</span>
										@endif
										|&nbsp;&nbsp;IOS Product Id : <span>{{ $r->app_store_product_id }}</span>
										...
										@endphp
										|&nbsp;&nbsp;IOS Product Type: <span>{{ $ios_type }}</span>
										</p>
									</div>
								</div>
						   </div>
						...
						<form method="post" action="{{ url('add_course')}}" enctype="multipart/form-data">
								@csrf
									...
									<div class="row">
										...
										<input type="number" name="reorder_no" class="form-control" required >
									</div>
									</div>
									</div>
	...
	<div class=" modal fade test_modal" id="kt_modal_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				...
				<label><b><u>Re-order Courses</u></b> </label>
...
//Mon Jan 15 2024 17:24:52 GMT+0530 (India Standard Time)
