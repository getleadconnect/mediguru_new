...
<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
	...
	<div class="kt-grid__item kt-app__toggle kt-app__aside kt-app__aside--lg kt-app__aside--fit" id="kt_chat_aside">
			...
			<div class="form-group" style="border:1px solid #e4e4e4;padding:10px;">
				<div class="row">
				<div class="col-lg-4">
					<input type="radio" class="chat-option st-radio" name="chat_option"  value="1" checked required><span style="color:#000;"><b> Students</b></span>
				</div>
				<div class="col-lg-4">
					<input type="radio" class="chat-option st-radio" name="chat_option"  value="2" required ><span style="color:#000;"><b> Course</b></span>
				</div>
							
				<div class="col-lg-4">
					<input type="radio" class="chat-option st-radio" name="chat_option"  value="3" required ><span style="color:#000;"><b> General</b></span>
				</div>
				</div>
			</div>
		...
		<div class="kt-portlet kt-portlet--last">
			<div class="kt-portlet__body" style="padding:10px 25px;">
				...
				<div class="ktw-1 kt-widget kt-widget--users kt-mt-20 pshow">
			    ...
			    <div class="ktw-2 kt-widget kt-widget--users kt-mt-20 phide">
					<div class="kt-scroll kt-scroll--pull">
						<div class="kt-widget__items kt-gen">
						
						@foreach($crs as $r)
						
							<div class="kt-widget__item" style="background: #e4e4e4;border-radius:23px;padding:5px 7px;">
								<span class="kt-media kt-media--circle">
									<!--<img src="assets/media/users/300_9.jpg" alt="image"> -->
									<div class="chat-icon-sm" style="background:#24578a !important;font-size:15px;margin-top:2px;">
									<img src="{{ config('constants.image_path').$r->course_icon }}" style="width:35px;height:35px;">
									</div>
								</span>
								<div class="kt-widget__info">
									<div class="kt-widget__section">
										<a href="#" class="course_uid kt-widget__username" id="{{ $r->unique_id }}" style="margin-top:6px;"><b>AIAGPT</b></a>
									</div>
								</div>
			    ...
			    <div class="ktw-3 kt-widget kt-widget--users kt-mt-20 phide">
					<div class="kt-scroll kt-scroll--pull">
						<div class="kt-widget__items">

						<div class="gen" style="padding:15px;width:80%;border:1px solid #c4c4c4;">
							<p>The General option is used to send message to all students.</p> 
						</div>
...
$(".chat-option").click(function()
{
	...
	if(op==1)
	{
		$(".ktw-1").removeClass('phide');
		$(".ktw-1").addClass('pshow');
		
		$(".ktw-2").removeClass('pshow');
		$(".ktw-2").addClass('phide');
		
		$(".ktw-3").removeClass('pshow');
		$(".ktw-3").addClass('phide');
	}
	else if(op==2)
	{
		$(".ktw-1").removeClass('pshow');
		$(".ktw-1").addClass('phide');
		
		$(".ktw-2").removeClass('phide');
		$(".ktw-2").addClass('pshow');
	...
	else if(op==3)
	{
		...
		$(".ktw-3").removeClass('phide');
		$(".ktw-3").addClass('pshow');
	}
});
...
$(".course_uid").click(function(e)
{
	...
	$(".kt-chat__title").html("General");
		
	jQuery.ajax({
		type: "GET",
		url: "get_course_chat_messages"+"/"+cid,
		dataType: 'html',
		//data: {vid: vid},
		success: function(res)
		{
						...
						'<div class="kt-chat__user">'+
						  '<div class="row">'+
							...
							'<div class="col-lg-11">'+
								...
								if(pic!='')
								{
									mesg+='<img onclick="view_image(this)" src="uploads/'+pic+'" style="widh:100px;height:100px;">';
								}
								else
								{
