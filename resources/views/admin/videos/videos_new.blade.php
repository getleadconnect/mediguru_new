				  ...
				  <div class="card">
					<div id="collapseOne4" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample4">
 					 <div class="card-body" style="background:#e2f0f7;">
						<label><b><u> Add Video Details:</u></b></label>
							...
							<div class="form-group">
								...
								<div class="col-lg-4 col-xl-4 col-xxl-4">
									<label >Video File(.mp4 files only)</label>
									<input type="file" id="video_file" onchange="return file_Validation();" name="video_file" class="form-control">
								</div>
							...
							<div class="col-lg-6 col-xl-6 col-xxl-6">
									...
									<input type="text" id="video_file_link" name="video_file_link" class="form-control" >
							</div>
...
$("form#myForm").submit(function(e)
{
	...
	if($("#video_file").val()=='' && $("#video_file_link").val()=='')
	{
	    alert("Select video file/Enter video link..!");
	}
	else
	{
       $.ajax({
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  ...
  /*$('#datatable tbody').on( 'click', '.view_video', function ()
  {
	var lnk=$(this).attr('res');
		...
		var vurl='<iframe src="'+lnk+'?h=ff80487f6b&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="margin:0px;width:400px;height:300px;" title="Nature (1)"></iframe>';
		Result.html(vurl);
  });*/
