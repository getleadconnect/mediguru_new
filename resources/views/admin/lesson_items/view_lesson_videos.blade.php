			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						<a href="{{ url('view_all_lesson_videos')}}" class="btn btn-success btn-xs"><i class="flaticon2-file"></i>View Lesson Videos </a>
						<a href="{{ url('view_all_lesson_materials')}}" class="btn btn-primary btn-xs"><i class="flaticon2-file"></i>View Lesson Materials </a>
				...
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
						<li class="nav-item">
							<!--<a href="{{url('view_all_lesson_videos')}}" class="btn-accordion btn btn-primary btn-xs"><i class="flaticon2-file"></i> View Lesson Items </a>-->
						</li>
