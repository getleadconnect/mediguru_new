			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						...
						<a href="{{ url('view_lesson_mcq_qpapers')}}" class="btn btn-success btn-xs"><i class="flaticon2-file"></i>View Lesson Mock Tests </a>
