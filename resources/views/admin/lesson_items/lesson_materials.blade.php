...
<div class="col-lg-12 col-xl-12 col-xxl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						...
						<a href="{{ url('lesson_materials')}}" class="btn btn-success btn-xs"><i class="flaticon2-plus"></i> Materials </a>
						<a href="{{ url('lesson_mcq_tests')}}" class="btn btn-primary btn-xs"><i class="flaticon2-plus"></i> Mock Test </a>
						<a href="{{ url('lesson_live_tests')}}" class="btn btn-primary btn-xs"><i class="flaticon2-plus"></i> Live Test </a>
					</h3>
				</div>
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
						<li class="nav-item">
							<a href="{{url('view_all_lesson_materials')}}" class="btn-accordion btn btn-primary btn-xs"><i class="flaticon2-file"></i> View Lesson Materials </a>
						</li>
			...
			<div class="kt-portlet__body">
				...
				<div class="col-lg-12 col-xl-12 col-xxl-12 pb-2">
					
					<label style="color:#2d2dcf;margin-top:5px;"> <b>Step-1</b> : Select Course, Subject and Lesson</label>
			...
			<hr style="margin:7px 0px 3px 0px;">
				...
				<label class="mt-3" style="color:#2d2dcf;"><b>Step-2</b> : Click [<i class="flaticon2-plus"></i>] button to add material into the lesson</label>
			...
			<div class="col-lg-6 col-xl-6 col-xxl-6">
				...
				<label class="mt-3" style="color:#2d2dcf;"><b><u>Material List : <span id="ltitle"> </span></u></b></label>
				...
				<div class="modal-body">
					...
					<form method="POST" id="lesForm"  enctype="multipart/form-data"> 
						@csrf
						       <div class="form-group">
								<label >Course Name </label>
								<select id="les_course_id" class="form-control " name="course_id" required>
									<option value="">--select--</option>
									@if(!empty($crs))
										@foreach($crs as $r)
											<option value="{{$r->id}}">{{ $r->course_name }}</option>
								...
								<div class="form-group">
								<label >Subject Name </label>
								<select id="les_subject_id" class="form-control " name="subject_id" required>
									<option value="">--select--</option>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="POST" id="ordForm"  enctype="multipart/form-data"> 
						@csrf
						
							<input type="hidden" id="mitem_id" name="mitem_id" value="">
...
function fileValidation2()
{
 ...
 $('#datatable2 tbody').on( 'click', '.btnOrder', function (e)
  {
	e.preventDefault();
	$("#mes").html("");
	$("#order_no").val("");
...
$("form#ordForm").submit(function(e)
{
	e.preventDefault();    
    var formData = new FormData(this);
    $.ajax({
        url: "add_material_order_no",  //chapter
        type: 'POST',
        data: formData,
        success: function (res) 
		{
			if(res>=1)
			{
				...
				$("#mes").html("<span style='color:green'>Material order No added.</span>");
				table1.draw();
			}
			else
			{
				$("#mes").html("<span style='color:red'>Something wrong, Try again.</span>");
			}
        },
        cache: false,
        contentType: false,
