...
<div class="col-lg-12 col-xl-12 col-xxl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						<a href="{{ url('lesson_videos')}}" class="btn btn-success btn-xs"><i class="flaticon2-plus"></i> Videos </a>
				...
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
						<li class="nav-item">
							<a href="" class="btn-accordion btn btn-primary btn-xs"><i class="flaticon2-file"></i> View Lesson Items </a>
						</li>
			...
			<hr style="margin:7px 0px 3px 0px;">
				...
				<label class="mt-3" style="color:#2d2dcf;"><b> Step-2</b> : Click [<i class="flaticon2-plus"></i>] button to add video into the lesson</label>
			...
			<div class="col-lg-6 col-xl-6 col-xxl-6">
				...
				<label class="mt-3" style="color:#2d2dcf;"><b><u>Video List : <span id="ltitle"> </span></u></b></label>
					...
					<!--<div style="overflow-x:scroll;width:500px;max-height:400px;">-->
						...
						<thead>
							...
							<th>Id</th>
							<th>icon</th>
							<th>Unique_id/Video_id/Title</th>
							<th>Order</th>
							</tr>
						</thead>
						<tbody>
							  ...
							  <div class="row">
								...
								<div class="form-group">
									<label>Lesson Icon(.jpg|.png) </label>
										<input type="file" onchange="fileValidation2();" id="lesson_icon" class="form-control" name="chapter_icon" required>
									</div>
								</div>
				...
				<div class="modal-body">
					...
					<form method="POST" id="ordForm"  enctype="multipart/form-data"> 
						@csrf
							...
							<input type="hidden" id="vitem_id" name="vitem_id" value="">
    ...
    $.ajax({
        ...
        success: function (res) 
		{
			...
			if(res>=1)
			{
				...
				$("#mes").html("<span style='color:green'>Video order No added.</span>");
				table1.draw();
			}
			else
			{
