...
<div class="kt-subheader-search ">
	<div class="kt-container  kt-container--fluid ">
		...
		Set Lesson MCQ Question Papers
	</h3>
</div>
</div>
...
<div class="col-lg-12 col-xl-12 col-xxl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						...
						<a href="{{ url('lesson_mcq_tests')}}" class="btn btn-success btn-xs"><i class="flaticon2-plus"></i> Mock Test </a>
				...
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
						<li class="nav-item">
							<a href="{{url('view_lesson_mcq_qpapers')}}" class="btn-accordion btn btn-primary btn-xs"><i class="flaticon2-file"></i> View Lesson Items </a>
						</li>
			...
			<hr style="margin:7px 0px 3px 0px;">
				...
				<label class="mt-3" style="color:#2d2dcf;"> <b>Step-2</b> : Click [<i class="flaticon2-plus"></i>] button to add question Paper into the lesson</label>
					...
					<form method="POST" id="subForm"  enctype="multipart/form-data"> 
						@csrf
							  ...
							  <div class="row">
								...
								<div class="form-group">
									<label>Subject Icon(.jpg|.png) </label>
 ...
 $('#datatable tbody').on( 'click', '.mselect', function ()
  ...
  $('#datatable2 tbody').on( 'click', '.btnDel', function (e)
  {
	...
	var lid=$(this).attr('id');
		...
		jQuery.ajax({
			type: "GET",
			url: "delete_lesson_mcq_test"+"/"+lid,
			dataType: 'html',
			//data: {},
			success: function(res)
			{
...
$("form#ordForm").submit(function(e)
{
    ...
    var formData = new FormData(this);
    $.ajax({
        url: "add_mcq_qpaper_order_no",  //chapter
        type: 'POST',
        data: formData,
        success: function (res) 
		{
			if(res>=1)
			{
				...
				$("#mes").html("<span style='color:green'>Question paper order No added.</span>");
				table1.draw();
			}
			else
			{
