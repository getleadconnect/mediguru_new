...
<div class="col-lg-12 col-xl-12 col-xxl-12">
		...
		<div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
			...
			<hr style="margin:7px 0px 3px 0px;">
				...
				<label class="mt-3" style="color:#2d2dcf;"> <b>Step-2</b> : Click [<i class="flaticon2-plus"></i>] button to add live question paper into the lesson</label>
				...
				<div class="modal-body">
					...
					<form method="POST" id="ordForm"  enctype="multipart/form-data"> 
						@csrf
							...
							<input type="hidden" id="ltitem_id" name="ltitem_id" value="">
...
$("form#ordForm").submit(function(e)
{
    ...
    var formData = new FormData(this);
    $.ajax({
        url: "add_live_test_order_no",  //chapter
        type: 'POST',
        data: formData,
        success: function (res) 
		{
