...
<div class="kt-subheader-search ">
	<div class="kt-container  kt-container--fluid ">
		...
		Mock Test Report (<small>Student Wise</small>)
	</h3>
</div>
</div>
			...
			<div class="kt-portlet__body">
				...
				<div class="accordion  accordion-toggle-arrow" id="accordionExample4">
					...
					<div id="collapseOne4" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample4">
						<div class="card-body" style="background:#e2f0f7;padding:10px 15px;">
							<label><b><u> Filter By:</u></b></label>
							<div class="row">
								<label class="col-lg-1 col-xl-1 col-xxl-1 col-form-label" >Course</label>
								<div class="col-lg-3 col-xl-3 col-xxl-3">
								   <select id="flt_course" class="form-control " name="flt_course" required>
								...
								<label class="col-lg-2 col-xl-2 col-xxl-2 col-form-label" >Select Student Name</label>
								<div class="col-lg-3 col-xl-3 col-xxl-3">	
								   <select id="flt_student" class="form-control " name="flt_student" style="width:100%;" required>
								   <option value="">--select--</option>
...
$("#flt_qpaper").select2();
 ...
 var table = $('#datatable').DataTable({
        ...
        ajax: {
			url:"view_student_data",
			data: function (data) 
		    {
				data.search = $('input[type="search"]').val();
				data.searchByStid = $('#flt_student').val();
		    },
		},
...
{
	var stid=$("#flt_student").val();
	if(stid!="")
	{
		var lnk="{{url('export_mcq_student_list')}}"+"/"+stid;
	    $("#exportToExcel").attr('href',lnk);	
	}
	else
	{
		//alert("please select question paper.");
		toastr.error("Please select question paper.");
	}
});
