...
<div class="kt-subheader-search ">
	<div class="kt-container  kt-container--fluid ">
		...
		Mock Test Report (<small>With Rank</small>)
	</h3>
</div>
</div>
					...
					<div id="collapseOne4" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample4">
						<div class="card-body" style="background:#e2f0f7;padding:10px 15px;">
							...
							<div class="row">
								...
								<label class="col-lg-1 col-xl-1 col-xxl-1 col-form-label">Q-Paper</label>
								<div class="col-lg-4 col-xl-4 col-xxl-4">
								   <select id="flt_qpaper" class="form-control " name="flt_qpaper" style="width:100%;" required>
								   <option value="">--select--</option>
...
$("#flt_qpaper").select2();
 ...
 var table = $('#datatable').DataTable({
        ...
        ajax: {
			url:"view_mcq_rank_wise_list",
			data: function (data) 
		    {
				data.search = $('input[type="search"]').val();
				data.searchByQpaper = $('#flt_qpaper').val();
		    },
		},
...
{
	var qpid=$("#flt_qpaper").val();
	if(qpid!="")
	{
		var lnk="{{url('export_mcq_rank_list')}}"+"/"+qpid;
...
$("#flt_course").change(function()
{
	...
	if(cid!="")
	{
	  jQuery.ajax({
		type: "GET",
		url: "get_question_paper_by_course_id"+"/"+cid,
		dataType: 'html',
		//data: {vid: vid},
		success: function(res)
		{
		   $("#flt_qpaper").empty();
		   $("#flt_qpaper").append(res);
		}
	  });
	}
