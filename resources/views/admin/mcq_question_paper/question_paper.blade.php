		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="post" action="{{url('save_question_paper')}}" enctype="multipart/form-data">
							@csrf
							...
							<div class="form-group">
								<label>Select Package </label>
									...
									<select id="package_id" class="form-control input-default " name="package_id" required>
									<option value="">--select--</option>
					...
					<div class="col-lg-6 col-xl-6 col-xxl-6"> <!--- seond column-->
							...
							<div class="form-group">
								<label>Description </label>
									<textarea rows=3 class="form-control" style="height:85px !important;" name="description" required> </textarea>
							</div>
