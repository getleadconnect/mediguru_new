(function($) {
 ...
 var dzChartlist = function(){
	...
	var multiLineChart = function(){
		//Multi-line labels
		//var leg=['First quarter of the year' , 'Second quarter of the year', 'Third quarter of the year', 'Fourth quarter of the year'];
		
		var leg= $("#chart_leg_text").val();
		var dat1= $("#chart_data1").val();
		var dat2= $("#chart_data2").val();
			
		var leg1=leg.split(",");
		var dat_1=dat1.split(",");
		var dat_2=dat2.split(",");
		//var stc=st1.split(",");
		...
		new Chartist.Bar('#multi-line-chart', {
			labels: leg1,
			series: [
			  //[600, 400, 800, 700 ,200,350,450,600,700],
			  //[300, 250, 400, 550 ,175,300,350,450,600],
			  dat_1,
			  dat_2,
			]
		},
